...
const Card =(props)=>{
    ...
    if(effect===true){
        //Dark
        return(
            <div className={StyleCard.containerDark}>
            ...
            <div className={StyleCard.containerCardDark}>
            {props.list.map((i)=>{
        ...
        //Light
        return(
            <div className={StyleCard.containerLight}>
                <div className={StyleCard.containerButtons}>
                ...
                <div className={StyleCard.title}>{props.children}</div>
            <div className={StyleCard.containerCardLight}>
            {props.list.map((i)=>{
